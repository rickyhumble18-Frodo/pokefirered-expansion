...
{
    { VAR_REMATCH_BROCK,    { TRAINER_LEADER_BROCK,    TRAINER_LEADER_BROCK_2    } },
    { VAR_REMATCH_MISTY,    { TRAINER_LEADER_MISTY,    TRAINER_LEADER_MISTY_2    } },
    { VAR_REMATCH_LT_SURGE, { TRAINER_LEADER_LT_SURGE, TRAINER_LEADER_LT_SURGE_2 } },
    { VAR_REMATCH_ERIKA,    { TRAINER_LEADER_ERIKA,    TRAINER_LEADER_ERIKA_2    } },
    { VAR_REMATCH_KOGA,     { TRAINER_LEADER_KOGA,     TRAINER_LEADER_KOGA_2     } },
    { VAR_REMATCH_SABRINA,  { TRAINER_LEADER_SABRINA,  TRAINER_LEADER_SABRINA_2  } },
    { VAR_REMATCH_BLAINE,   { TRAINER_LEADER_BLAINE,   TRAINER_LEADER_BLAINE_2   } },
    { VAR_REMATCH_GIOVANNI, { TRAINER_LEADER_GIOVANNI, TRAINER_LEADER_GIOVANNI_2 } },
    { VAR_REMATCH_LORELEI,  { TRAINER_ELITE_FOUR_LORELEI, TRAINER_ELITE_FOUR_LORELEI_2 } },
    { VAR_REMATCH_BRUNO,    { TRAINER_ELITE_FOUR_BRUNO,   TRAINER_ELITE_FOUR_BRUNO_2   } },
    { VAR_REMATCH_AGATHA,   { TRAINER_ELITE_FOUR_AGATHA,  TRAINER_ELITE_FOUR_AGATHA_2  } },
    { VAR_REMATCH_LANCE,    { TRAINER_ELITE_FOUR_LANCE,   TRAINER_ELITE_FOUR_LANCE_2   } },
    { VAR_REMATCH_CHAMPION, { TRAINER_CHAMPION_FIRST_SQUIRTLE,   TRAINER_CHAMPION_REMATCH_SQUIRTLE   } },
    { VAR_REMATCH_CHAMPION, { TRAINER_CHAMPION_FIRST_BULBASAUR,  TRAINER_CHAMPION_REMATCH_BULBASAUR  } },
    { VAR_REMATCH_CHAMPION, { TRAINER_CHAMPION_FIRST_CHARMANDER, TRAINER_CHAMPION_REMATCH_CHARMANDER } },
};
...
static const struct BossRematch *FindBossRematch(enum TrainerID trainerId)
{
    ...
    {
        for (j = 0; j < ARRAY_COUNT(sBossRematches[i].variants); j++)
        {
...
enum TrainerID GetBossVariantTrainerId(enum TrainerID trainerId)
{
    ...
    return boss->variants[VarGet(boss->counterVar) % ARRAY_COUNT(boss->variants)];
}
