...
// The plain Poke Ball pic backs the ungated sPicTable_PokeBall /
// gObjectEventGraphicsInfo_PokeBall, so it must exist even when the
// per-ball follower variants below are compiled out.
