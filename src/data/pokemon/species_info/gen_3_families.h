...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SLAKING] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TRUANT, ABILITY_SCRAPPY, ABILITY_NONE }, // Kaizo superboss ability (see docs/rematch_scaling.md).
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_RAYQUAZA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_AIR_LOCK, ABILITY_DELTA_STREAM, ABILITY_NONE }, // Kaizo superboss ability (see docs/rematch_scaling.md).
        .bodyColor = BODY_COLOR_GREEN,
