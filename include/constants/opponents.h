...
enum TrainerID
{
    ...
    TRAINER_LEADER_GIOVANNI_2,
    TRAINER_SUPERBOSS_FRODO,
    TRAINER_SUPERBOSS_FRODO_2,
    TRAINER_SUPERBOSS_FRODO_3,
    // GEN_ROUTE_TRAINERS_BEGIN
    TRAINER_HIKER_DWAYNE,
    TRAINER_HIKER_DWAYNE_2,
    TRAINER_CAMPER_TOBIAS,
    TRAINER_CAMPER_TOBIAS_2,
    TRAINER_LASS_PRISCILLA,
    TRAINER_LASS_PRISCILLA_2,
    TRAINER_BUG_CATCHER_MARV,
    TRAINER_BUG_CATCHER_MARV_2,
    TRAINER_LASS_ODETTE,
    TRAINER_LASS_ODETTE_2,
    TRAINER_FISHERMAN_DOUGAL,
    TRAINER_FISHERMAN_DOUGAL_2,
    TRAINER_BUG_CATCHER_PERCY,
    TRAINER_BUG_CATCHER_PERCY_2,
    TRAINER_YOUNGSTER_ROLAND,
    TRAINER_YOUNGSTER_ROLAND_2,
    TRAINER_SUPER_NERD_EWALD,
    TRAINER_SUPER_NERD_EWALD_2,
    TRAINER_BIKER_AXEL,
    TRAINER_BIKER_AXEL_2,
    TRAINER_HIKER_BRUNO,
    TRAINER_HIKER_BRUNO_2,
    TRAINER_POKEMANIAC_DEXTER,
    TRAINER_POKEMANIAC_DEXTER_2,
    TRAINER_SUPER_NERD_OHMER,
    TRAINER_SUPER_NERD_OHMER_2,
    TRAINER_HIKER_GRANT,
    TRAINER_HIKER_GRANT_2,
    TRAINER_POKEMANIAC_SILAS,
    TRAINER_POKEMANIAC_SILAS_2,
    TRAINER_ROCKER_ZIGGY,
    TRAINER_ROCKER_ZIGGY_2,
    TRAINER_FISHERMAN_MARLON,
    TRAINER_FISHERMAN_MARLON_2,
    TRAINER_BEAUTY_SERENA,
    TRAINER_BEAUTY_SERENA_2,
    TRAINER_ROCKER_JAX,
    TRAINER_ROCKER_JAX_2,
    TRAINER_FISHERMAN_CLETUS,
    TRAINER_FISHERMAN_CLETUS_2,
    TRAINER_BEAUTY_LACEY,
    TRAINER_BEAUTY_LACEY_2,
    TRAINER_PSYCHIC_MORDECAI,
    TRAINER_PSYCHIC_MORDECAI_2,
    TRAINER_BIKER_RAZOR,
    TRAINER_BIKER_RAZOR_2,
    TRAINER_BEAUTY_VIVIAN,
    TRAINER_BEAUTY_VIVIAN_2,
    TRAINER_BIKER_CLUTCH,
    TRAINER_BIKER_CLUTCH_2,
    TRAINER_BIKER_TORQUE,
    TRAINER_BIKER_TORQUE_2,
    TRAINER_BIKER_NITRO,
    TRAINER_BIKER_NITRO_2,
    TRAINER_BEAUTY_CARMEN,
    TRAINER_BEAUTY_CARMEN_2,
    TRAINER_BIKER_SPARK,
    TRAINER_BIKER_SPARK_2,
    TRAINER_BIKER_DIESEL,
    TRAINER_BIKER_DIESEL_2,
    TRAINER_POKEMANIAC_WENDELL,
    TRAINER_POKEMANIAC_WENDELL_2,
    TRAINER_HIKER_BOULDER,
    TRAINER_HIKER_BOULDER_2,
    TRAINER_SWIMMER_F_MARINA,
    TRAINER_SWIMMER_F_MARINA_2,
    TRAINER_SWIMMER_M_REEF,
    TRAINER_SWIMMER_M_REEF_2,
    TRAINER_SWIMMER_M_TIDE,
    TRAINER_SWIMMER_M_TIDE_2,
    TRAINER_BLACK_BELT_KENJI,
    TRAINER_BLACK_BELT_KENJI_2,
    TRAINER_SWIMMER_F_PEARL,
    TRAINER_SWIMMER_F_PEARL_2,
    TRAINER_FISHERMAN_SALTON,
    TRAINER_FISHERMAN_SALTON_2,
    TRAINER_SWIMMER_M_CREST,
    TRAINER_SWIMMER_M_CREST_2,
    TRAINER_SWIMMER_F_CORAL,
    TRAINER_SWIMMER_F_CORAL_2,
