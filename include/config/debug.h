...
// Overworld Debug
#define DEBUG_OVERWORLD_MENU            TRUE // Enables an overworld debug menu to change flags, variables, giving pokemon and more, accessed by holding R and pressing START while in the overworld by default. Kept on in release builds so rematch scaling tiers can be tested (VAR_REMATCH_* in the Vars editor).
