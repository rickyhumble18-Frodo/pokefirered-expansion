...
#define P_SUMMARY_SCREEN_IV_DISPLAY      P_SUMMARY_SCREEN_IV_NUMBER // Change this to one of the above options to set what shows in the summary screen for IVs. Numbers so exact IVs (31s) are verifiable.
/*
LETTER GRADE GUIDE:
